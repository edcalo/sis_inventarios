...
<?php echo $this->Form->create('PlanPago');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Plan Pago'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PlanPago.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PlanPago.id'))); ?></li>
