<div class="facturaItemes index">
	<h2><?php echo __('Factura Itemes');?></h2>
	...
	<?php
	foreach ($facturaItemes as $facturaItem): ?>
	<tr>
		<td><?php echo h($facturaItem['FacturaItem']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($facturaItem['FacturaItem']['cantidad']); ?>&nbsp;</td>
		<td><?php echo h($facturaItem['FacturaItem']['precio_venta']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $facturaItem['FacturaItem']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $facturaItem['FacturaItem']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $facturaItem['FacturaItem']['id']), null, __('Are you sure you want to delete # %s?', $facturaItem['FacturaItem']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
