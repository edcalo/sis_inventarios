...
<?php echo $this->Form->create('ComprasItem');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Compras Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ComprasItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ComprasItem.id'))); ?></li>
