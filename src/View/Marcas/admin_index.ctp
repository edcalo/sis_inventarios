<div class="marcas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('nombre_marca');?></th>
	...
	<tr>
		...
		<td><?php echo h($marca['Marca']['nombre_marca']); ?>&nbsp;</td>
		<td><?php echo h($marca['Marca']['descripcion_marca']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $marca['Marca']['id']), null, __('Are you sure you want to delete # %s?', $marca['Marca']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
